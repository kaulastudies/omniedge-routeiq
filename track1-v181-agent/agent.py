...
def request_batch(tasks: list[dict[str, Any]], model: str, api_key: str, url: str) -> dict[str, str]:
    payload = {
        ...
        "temperature": 0,
        "max_tokens": min(4096, max(256, 220 * len(tasks))),
        "stream": False,
